    ...
    while (listSize(worklist) > 0) {
        ...
        if (bytecode != null) {
            ...
            while (bi < listSize(bytecode)) {
                ...
                if (byte == 19) {
                    // CONST_STRING: dest(2), constIdx(2)
