...
/// Tokenizes Moon source code into a stream of `Token`s.
///
/// The lexer is a single-pass scanner that processes UTF-8 source text
/// character by character. It handles:
/// - All Moon keywords (Kotlin-inherited + Moon-specific)
/// - String literals with `${}` interpolation
/// - Integer and floating-point number literals (decimal, hex, binary)
/// - Single-line (`//`) and multi-line (`/* */`) comments
/// - All operators and delimiters from the Moon spec grammar
/// - Significant newlines (Moon uses newlines as statement terminators)
