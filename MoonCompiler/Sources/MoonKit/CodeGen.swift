...
public final class CodeGen {
    ...
    private func encodeTypeDecl(_ typeDecl: MIRTypeDecl) -> BytecodeTypeDecl {
        ...
        return BytecodeTypeDecl(nameIndex: nameIdx, fields: fields, methods: methods)
    }

    // MARK: - Binary Serialization

    /// Serialize a BytecodeModule to raw bytes (.moonb format).
    ...
    public static func disassemble(_ module: BytecodeModule) -> String {
        var lines: [String] = []
        lines.append("// Moon Bytecode Module")
