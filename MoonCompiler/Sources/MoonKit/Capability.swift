...
/// Describes a platform capability that a Moon program may request.
...
///
/// In the Moon runtime, capabilities are explicit declarations that
...
/// platform integration happens in later stages when Moon runs natively.
