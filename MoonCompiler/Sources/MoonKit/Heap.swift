...
/// A heap-allocated Moon object with type metadata and fields.
public final class MoonObject {
...
/// Object heap for the Moon VM. Manages allocation, deallocation,
/// and field access for heap-allocated objects.
public final class Heap {
    /// All allocated objects, indexed by ObjectID.
    private var objects: [MoonObject?] = []
    ...
    public func allocate(typeName: String, fields: [String: Value] = [:]) -> ObjectID {
        let obj = MoonObject(typeName: typeName, fields: fields)
        totalAllocations += 1
    ...
    public func get(_ id: ObjectID) throws -> MoonObject {
